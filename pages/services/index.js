  ...
  return (
    <div className='h-full bg-primary py-40 text-white'>
      ...
      <div className='container mx-auto'>
        ...
        {/* service list */}
        <div className='grid grid-cols-1 xl:grid-cols-3 gap-6 xl:gap-6 xl:px-0 overflow-y-scroll h-[500px] scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-white/10 pr-2 xl:h-auto xl:overflow-visible'>

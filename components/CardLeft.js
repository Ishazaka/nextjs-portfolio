const CardLeft = ({ data }) => {
  ...
  return (
    <div className='relative group bg-[#1E1E31] xl:h-44 mb-6 xl:mb-12 p-4 before:absolute before:w-[16px] before:h-[1px] before:bg-white/10 before:-right-4 after:absolute after:w-4 after:h-4 after:bg-[#2F303E] after:-right-6 after:top-2 after:rounded-full after:z-10 hover:after:bg-accent  before:hidden after:hidden xl:before:flex xl:after:flex after:transition-all after:duration-300 rounded-md flex flex-col items-center text-center'>

                    ...
                    <div className='relative group flex justify-center items-center overflow-hidden'>
                      ...
                      <div className='absolute bottom-0 translate-y-full group-hover:-translate-y-20 transition-all duration-300'>
                        <div className='flex items-center gap-x-2'>
                          <div className='text-[13px] tracking-[0.2em] delay-100'>
                            LIVE
                          </div>
                          <div className='text-[13px] tracking-[0.2em] translate-y-[500%] group-hover:translate-y-0 transition-all duration-300 delay-150'>
                            PROJECT
                          </div>
